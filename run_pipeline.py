...
def run_pipeline(ref_path, src_path, loftr_repo_dir, loftr_weights, out_dir="output",
   ...
   # ---- 4. Optical Preprocessor ---------------------------------------
    ...
    # --- Conditional Padding: ONLY for TIF vs XML comparisons ---
...
if __name__ == "__main__":
    ...
    run_pipeline(
        ref_path="data/dataset/M190971879CC vs ch2_iir_nci_20210726T2321258813_d_img_d32/M190971879CC.TIF", 
        src_path="data/dataset/M190971879CC vs ch2_iir_nci_20210726T2321258813_d_img_d32/ch2_iir_nci_20210726T2321258813_d_img_d32.xml",
        loftr_repo_dir="./LoFTR",                           # Fixed path
        loftr_weights="./LoFTR/weights/outdoor_ds.ckpt",    # Fixed path
        out_dir="output/M190971879CC vs ch2_iir_nci_20210726T2321258813_d_img_d32", 
        ...
        is_iirs=True                                      # Dynamic thermal trigger
    )
